import unittest, student_controller, os
...
class TestStudentController(unittest.TestCase):
    def test_load_students(self):
        ...
        self.assertEqual(student_data, {'001': 'id:001,first_name:willy,last_name:Sugira', '002': 'id:002,first_name:willy,last_name:Sugira', '003': 'id:003,first_name:willy,last_name:Sugira'})
    ...
    def test_is_student_added(self):
        ...
        added_student = student_class.add_to_final_list(f'{FILE_NAME}.txt', user_id, student_final_data)
